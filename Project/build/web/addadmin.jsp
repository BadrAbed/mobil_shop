...
<link href="styles.css" rel="stylesheet" type="text/css" />
    ...
    <div class="mainContent">
        ...
        <form action="Addnewuser" >
            ...
            <p><b> <center> <font size="6"> Enter New Data </center> </b></p>
            <br/>
  <font size="4" color="red"> 
            <table>
                <tr>
                ...
                <tr>
                    <td>mobile no</td>
                    <td><input type="tel" name="mn" required placeholder="Enter a valid moblie"  onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
                </tr>
            
                    <tr>
                    <td>   login type:<br/> 
                
                <input type="radio" name="login type" value="1" required/> admin <br/>
