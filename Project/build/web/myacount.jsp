...
<%
    if(session.getAttribute("userObj")!=null){
      ...
      //  out.print("Welcome,Company " +u.getType()+u.getName());
...
<div id="container">
    ...
    <table border="8" width="50%" cellspacing="40" height="90%" align="center">
        <thead>
            <tr>
                <th> <li><a href="useraddprod.jsp">ADDProudect</a></li></th>
            </tr>
        
            <tr>
                <th>  <li><a href="#">Delete Proudect</a></li></th></th>
            </tr>
            <tr>
                <th> <li><a href="#">View Proudect</a></li></th> </th>
            </tr>
             <tr>
                <th> <li><a href="#">update Proudect</a></li></th> </th>
            </tr>
             <tr>
                 <th> <li><a href="view my profile.jsp">View my profile</a></li></th> </th>
            </tr>
