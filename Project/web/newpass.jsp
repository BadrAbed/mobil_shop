<%-- 
    Document   : forogetusername
    Created on : May 12, 2015, 10:53:47 AM
    Author     : Badr
--%>
...
<html>
    ...
    <body>
        ...
        <font size="4" color="red">   your newpass: <input type="password" name="pass" required placeholder="Enter password"/></td>
     
       <input type="submit" value="login" />
   
    </form>
         <center> <a href="index.jsp"> <font size="4" color="red">Back to main menu</a> </center>
         <!-- begin #container -->
<div id="container">
	<!-- begin #header -->
    <div id="header">
