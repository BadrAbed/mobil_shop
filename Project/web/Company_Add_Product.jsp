    ...
    <body>
      ...
      <form action="CompanyADDProduct">
          Product Name:  <input type="text" name="product_name" value="" required><br>
                 Company Email:   <select name="c_email" required>
           ...
           Product Code:<input type="text" name="product_code" value="" required onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode ==="." ' ><br>
