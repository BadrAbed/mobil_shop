...
<body>
    ...
    <br/>
            ...
            <table border="5" width="20%" cellspacing="5" align="center">
                 <form method="post" action="Control">
       
           
            <tr>
                <td>  E_Mail: <input type="email" name="mail" required placeholder="Enter an email"/></td>
            </tr>
       
      
            <tr>
                <td>  password:<input type="password" name="pass" required placeholder="Enter a password"/></td>
            </tr>
                     <tr>
                         <td>
                             <a href="forogetusername.jsp"> <font size="4" color="red"> forgot username or password</a>
                         </td>
                     </tr>
            <tr>
               
                <td>  <input type="submit" value="login" /> <center> <a href="signin.jsp"> <font size="4" color="red">Sign in</a> </center> </td>
    ...
    <div class="mainContent">
        ...
        <div class="bodySidebar">
            ...
            <div class="copyrights">
            	...
            	<p>
                	We request you retain the full copyright notice below including the link to <a href="http://www.Free-Flash-Websites.com">www.Free-Flash-Websites.com</a>. This not only gives respect to the large amount of time given freely by the developers but also helps build interest, traffic and use of our free and paid designs. If you cannot (for good reason) retain the full copyright we request you at least leave in place the Website Templates line, with Website Templates linked to www.Free-Flash-Websites.com. If you refuse to include even this then support may be affected.<br /><br />
                    ...
                    For support please visit <a href="http://Free-Flash-Websites.com/contact.php ">http://Free-Flash-Websites.com/contact.php </a>
                </p>
            </div>
        </div>
    </div>
